...
CREATE TABLE Uczniowie (idUczen int(10) NOT NULL AUTO_INCREMENT, UzytkownicyidUzytkownik int(10) NOT NULL, KlasyidKlasa int(10), RodziceidRodzic int(10), PRIMARY KEY (idUczen)) CHARACTER SET UTF8;
CREATE TABLE Rodzice (idRodzic int(10) NOT NULL, UzytkownicyidUzytkownik int(10) NOT NULL, PRIMARY KEY (idRodzic)) CHARACTER SET UTF8;
CREATE TABLE Nauczyciele (idNauczyciel int(10) NOT NULL AUTO_INCREMENT, UzytkownicyidUzytkownik int(10) NOT NULL, TytulNaukowy varchar(31) NOT NULL, PRIMARY KEY (idNauczyciel)) CHARACTER SET UTF8;
...
CREATE TABLE Administratorzy (idAdministrator int(10) NOT NULL AUTO_INCREMENT, UzytkownicyidUzytkownik int(10) NOT NULL, PRIMARY KEY (idAdministrator)) CHARACTER SET UTF8;
...
ALTER TABLE Uczniowie ADD CONSTRAINT Ma FOREIGN KEY (RodziceidRodzic) REFERENCES Rodzice (idRodzic);
...
ALTER TABLE Zajecia ADD CONSTRAINT Prowadzi FOREIGN KEY (NauczycieleidNauczyciel) REFERENCES Nauczyciele (idNauczyciel);
...
ALTER TABLE Obecnosci ADD CONSTRAINT MaObecnosc FOREIGN KEY (UczniowieidUczen) REFERENCES Uczniowie (idUczen);
ALTER TABLE Oceny ADD CONSTRAINT Otrzymuje FOREIGN KEY (UczniowieidUczen) REFERENCES Uczniowie (idUczen);
...
ALTER TABLE Specjalnosci ADD CONSTRAINT MaSpecjalnosc FOREIGN KEY (NauczycieleidNauczyciel) REFERENCES Nauczyciele (idNauczyciel);
ALTER TABLE Obecnosci ADD CONSTRAINT UsprawiedliwiaRodzic FOREIGN KEY (RodziceidRodzic) REFERENCES Rodzice (idRodzic);
ALTER TABLE Obecnosci ADD CONSTRAINT UsprawiedliwaNauczyciel FOREIGN KEY (NauczycieleidNauczyciel) REFERENCES Nauczyciele (idNauczyciel);
...
ALTER TABLE Rodzice ADD CONSTRAINT JestRodzicem FOREIGN KEY (UzytkownicyidUzytkownik) REFERENCES Uzytkownicy (idUzytkownik);
ALTER TABLE Administratorzy ADD CONSTRAINT JestAdministratorem FOREIGN KEY (UzytkownicyidUzytkownik) REFERENCES Uzytkownicy (idUzytkownik);
ALTER TABLE Nauczyciele ADD CONSTRAINT JestNauczycielem FOREIGN KEY (UzytkownicyidUzytkownik) REFERENCES Uzytkownicy (idUzytkownik);
ALTER TABLE Uczniowie ADD CONSTRAINT JestUczniem FOREIGN KEY (UzytkownicyidUzytkownik) REFERENCES Uzytkownicy (idUzytkownik);
...
ALTER TABLE Klasy ADD CONSTRAINT JestWychowawca FOREIGN KEY (NauczycieleidNauczyciel) REFERENCES Nauczyciele (idNauczyciel);