...
CREATE TABLE Administratorzy (idUzytkownik int(10) NOT NULL AUTO_INCREMENT, UzytkownicyidUzytkownik int(10) NOT NULL, PRIMARY KEY (idAdministrator)) CHARACTER SET UTF8;
